...
var Game = {
  ...
  gameOver: function(){
  	...
  	var message3 = "press oK to Play Again";
	  if(this.score > this.highscore){
		this.highscore = this.score;
		localStorage.setItem('highscore', this.highscore);
	  }
	  var message4 = "Highscore: " + this.highscore;
	  this.ctx.fillText(message4, this.c.width/2 - this.ctx.measureText(message4).width/2, this.c.height/2 + 50);
  	this.pause();
  ...
  updateScore: function(){
	  ...
	  this.ctx.fillText("Highscore: " + this.highscore, 8, 60);
  },
